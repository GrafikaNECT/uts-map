...
bin/mainGIS3D.out: src/lib/*.cpp src/include/*.h src/main/mainGIS3D.cpp Makefile
	g++ -o bin/mainGIS3D.out src/main/mainGIS3D.cpp src/lib/GIS3D.cpp src/lib/Model3D.cpp src/lib/SolidPolygon3D.cpp src/lib/Point3D.cpp src/lib/SolidPolygon.cpp src/lib/Point.cpp src/lib/Printer.cpp src/lib/Texture.cpp src/lib/Kbhit.cpp src/lib/WeatherInformation.cpp src/lib/Weather.cpp src/lib/WeatherAnimation.cpp src/lib/Animation.cpp src/lib/CurveCollection.cpp src/lib/Curve.cpp src/lib/CurveShape.cpp src/lib/City.cpp src/lib/AlphabetCurve.cpp -std=c++11 -fpermissive -lpthread -g
